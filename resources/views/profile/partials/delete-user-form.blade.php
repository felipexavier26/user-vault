<section class="space-y-6">
    ...
    <x-danger-button
        ...
        class="bg-red-600 hover:bg-red-700 text-white dark:bg-red-500 dark:hover:bg-red-400"
    >
        {{ __('Excluir conta') }}
    </x-danger-button>
        ...
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6 dark:bg-gray-800">
            ...
            <div class="mt-6">
                ...
                <x-text-input
                    ...
                    name="password"
                    type="password"
                    class="mt-1 block w-3/4 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800"
            ...
            <div class="mt-6 flex justify-end">
                ...
                <x-danger-button
                    class="ms-3 bg-red-600 hover:bg-red-700 text-white dark:bg-red-500 dark:hover:bg-red-400"
                >
                    {{ __('Excluir conta') }}
                </x-danger-button>
            </div>
